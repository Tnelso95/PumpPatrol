...
class CustomWorkoutSessionFrag : Fragment() {
...
//        // In your CustomWorkoutSessionFragment onCreateView:
...
//            Toast.makeText(requireContext(), "No custom workout data provided", Toast.LENGTH_SHORT).show()
//            findNavController().navigateUp()
//            return root
//        }
// Now you have your custom workout configuration without needing Gson.
